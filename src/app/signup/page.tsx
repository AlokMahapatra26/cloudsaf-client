        ...
        <div className="flex items-center justify-center h-screen">
            ...
            >
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className={`w-full p-3 flex items-center justify-center gap-2 text-white bg-blue-600 rounded-lg transition duration-200 ${loading ? 'opacity-70 cursor-not-allowed' : 'cursor-pointer'}`}
                >
                    {loading ? (
                        <>
                            <svg
